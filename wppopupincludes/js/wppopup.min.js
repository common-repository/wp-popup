...
function removeMessageBoxForever(){jQuery(this).parents('#messagebox').removeClass('visiblebox').addClass('hiddenbox');createCookie('wppopup_never_view','hidealways',365);return false;}
